<template>
  <form class="ReservoirDetailMonitorAdd" ref="monitorAdd">
    <ul class="others">
      <li class="line-bottom">
        <label class="label" for="z">水位</label>
        <div class="inputBox">
          <input type="text" id="z" name="z" placeholder="请输入水位值(m)" v-model="form.z">
        </div>
      </li>
      <li class="line-bottom">
        <h6 class="h6">时间</h6>
      ...
      <li class="line-bottom line-top divide">
        ...
        <div class="inputBox">
          <input type="text" id="drp" name="drp" placeholder="请输入雨量值(mm)" v-model="form.drp">
        </div>
      </li>
      <li class="line-bottom">
        <h6 class="h6">时间</h6>
      ...
      <li class="line-bottom line-top divide">
        ...
        <div class="inputBox">
          <input type="text" id="gsl" name="gsl" placeholder="请输入供水量值(m³)" v-model="form.gsl">
        </div>
      </li>
      <li class="line-bottom">
        <h6 class="h6">时间</h6>
      ...
      <li class="line-bottom line-top divide">
        ...
        <div class="inputBox">
          <input type="text" id="origdata" name="origdata" placeholder="565(L/s )" v-model="form.origdata">
        </div>
      </li>
      <li class="line-bottom">
        <h6 class="h6">时间</h6>
    ...
    <ul class="quality">
      ...
      <li class="line-bottom line-top">
        ...
        <div class="inputBox">
          <input type="text" id="wt" name="wt" placeholder="℃" v-model="form.quality.wt">
        </div>
      </li>
      <li class="line-bottom">
        <label class="label" for="dox">溶解氧</label>
        <div class="inputBox">
          <input type="text" id="dox" name="dox" placeholder="≥5mg/L" v-model="form.quality.dox">
        </div>
      </li>
      <li class="line-bottom">
        <label class="label" for="ph">pH值</label>
        <div class="inputBox">
          <input type="text" id="ph" name="ph" placeholder="6.0－9.0" v-model="form.quality.ph">
        </div>
      </li>
      <li class="line-bottom">
        <label class="label" for="tp">总磷(以P计)</label>
        <div class="inputBox">
          <input type="text" id="tp" name="tp" placeholder="≤0.2mg/L" v-model="form.quality.tp">
        </div>
      </li>
      <li class="line-bottom">
        <label class="label" for="codmn">高锰酸盐指数</label>
        <div class="inputBox">
          <input type="text" id="codmn" name="codmn" placeholder="≤6mg/L" v-model="form.quality.codmn">
        </div>
      </li>
      <li class="line-bottom">
        <label class="label" for="condcr">化学需氧量（COD）</label>
        <div class="inputBox">
          <input type="text" id="condcr" name="condcr" placeholder="≤20mg/L" v-model="form.quality.condcr">
        </div>
      </li>
      <li class="line-bottom">
        <label class="label" for="bod5">五日生化需氧量（BOD<sub>5</sub>）</label>
        <div class="inputBox">
          <input type="text" id="bod5" name="bod5" placeholder="≤4mg/L" v-model="form.quality.bod5">
        </div>
      </li>
      <li class="line-bottom">
        <label class="label" for="nh3N">氨氮（NH<sub>3</sub>—N）</label>
        <div class="inputBox">
          <input type="text" id="nh3N" name="nh3N" placeholder="≤1.0mg/L" v-model="form.quality.nh3N">
        </div>
      </li>
      <li class="line-bottom">
        <label class="label" for="tn">总氮（以N计）</label>
        <div class="inputBox">
          <input type="text" id="tn" name="tn" placeholder="≤1.0mg/L" v-model="form.quality.tn">
        </div>
      </li>
      <li class="line-bottom">
        <label class="label" for="cu">铜</label>
        <div class="inputBox">
          <input type="text" id="cu" name="cu" placeholder="≤1.0mg/L" v-model="form.quality.cu">
        </div>
      </li>
      <li class="line-bottom">
        <label class="label" for="zn">锌</label>
        <div class="inputBox">
          <input type="text" id="zn" name="zn" placeholder="≤1.0mg/L" v-model="form.quality.zn">
        </div>
      </li>
      <li class="line-bottom">
        <label class="label" for="f">氟化物</label>
        <div class="inputBox">
          <input type="text" id="f" name="f" placeholder="≤1.0mg/L" v-model="form.quality.f">
        </div>
      </li>
      <li class="line-bottom">
        <label class="label" for="se">硒</label>
        <div class="inputBox">
          <input type="text" id="se" name="se" placeholder="≤0.01mg/L" v-model="form.quality.se">
        </div>
      </li>
      <li class="line-bottom">
        <label class="label" for="ars">砷</label>
        <div class="inputBox">
          <input type="text" id="ars" name="ars" placeholder="≤0.05mg/L" v-model="form.quality.ars">
        </div>
      </li>
      <li class="line-bottom">
        <label class="label" for="hg">汞</label>
        <div class="inputBox">
          <input type="text" id="hg" name="hg" placeholder="≤0.0001mg/L" v-model="form.quality.hg">
        </div>
      </li>
      <li class="line-bottom">
        <label class="label" for="cd">镉</label>
        <div class="inputBox">
          <input type="text" id="cd" name="cd" placeholder="≤0.005mg/L" v-model="form.quality.cd">
        </div>
      </li>
      <li class="line-bottom">
        <label class="label" for="cr6">铬（六价）</label>
        <div class="inputBox">
          <input type="text" id="cr6" name="cr6" placeholder="≤0.05mg/L" v-model="form.quality.cr6">
        </div>
      </li>
      <li class="line-bottom">
        <label class="label" for="pb">铅</label>
        <div class="inputBox">
          <input type="text" id="pb" name="pb" placeholder="≤0.05mg/L" v-model="form.quality.pb">
        </div>
      </li>
      <li class="line-bottom">
        <label class="label" for="cn">氰化物</label>
        <div class="inputBox">
          <input type="text" id="cn" name="cn" placeholder="≤0.2mg/L" v-model="form.quality.cn">
        </div>
      </li>
      <li class="line-bottom">
        <label class="label" for="vlph">挥发酚</label>
        <div class="inputBox">
          <input type="text" id="vlph" name="vlph" placeholder="≤0.005mg/L" v-model="form.quality.vlph">
        </div>
      </li>
      <li class="line-bottom">
        <label class="label" for="oil">石油类</label>
        <div class="inputBox">
          <input type="text" id="oil" name="oil" placeholder="≤0.05mg/L" v-model="form.quality.oil">
        </div>
      </li>
      <li class="line-bottom">
        <label class="label" for="las">阴离子表面活性剂</label>
        <div class="inputBox">
          <input type="text" id="las" name="las" placeholder="≤0.2mg/L" v-model="form.quality.las">
        </div>
      </li>
      <li class="line-bottom">
        <label class="label" for="s2">硫化物</label>
        <div class="inputBox">
          <input type="text" id="s2" name="s2" placeholder="≤0.2mg/L" v-model="form.quality.s2">
        </div>
      </li>
      <li class="line-bottom">
        <label class="label" for="fcg">粪大肠菌群</label>
        <div class="inputBox">
          <input type="text" id="fcg" name="fcg" placeholder="≤10000个/L" v-model="form.quality.fcg">
        </div>
      </li>
      <li class="line-bottom">
        <label class="label" for="so4">硫酸盐（以SO<sub>4</sub><sup>2-</sup>计）</label>
        <div class="inputBox">
          <input type="text" id="so4" name="so4" placeholder="≤250mg/L" v-model="form.quality.so4">
        </div>
      </li>
      <li class="line-bottom">
        <label class="label" for="cl">氯化物（以Cl<sup>-</sup>计）</label>
        <div class="inputBox">
          <input type="text" id="cl" name="cl" placeholder="≤250mg/L" v-model="form.quality.cl">
        </div>
      </li>
      <li class="line-bottom">
        <label class="label" for="no3">硝酸盐氮（以N计）</label>
        <div class="inputBox">
          <input type="text" id="no3" name="no3" placeholder="2.2mg/L" v-model="form.quality.no3">
        </div>
      </li>
      <li class="line-bottom">
        <label class="label" for="fe">铁</label>
        <div class="inputBox">
          <input type="text" id="fe" name="fe" placeholder="≤0.3mg/L" v-model="form.quality.fe">
        </div>
      </li>
      <li class="line-bottom">
        <label class="label" for="mn">锰</label>
        <div class="inputBox">
          <input type="text" id="mn" name="mn" placeholder="≤0.1mg/L" v-model="form.quality.mn">
        </div>
      </li>
      <li class="line-bottom">
        <label class="label" for="bjq">百菌清</label>
        <div class="inputBox">
          <input type="text" id="bjq" name="bjq" placeholder="≤0.01mg/L" v-model="form.quality.bjq">
        </div>
      </li>
      <li class="line-bottom">
        <label class="label" for="sljw">三氯甲烷</label>
        <div class="inputBox">
          <input type="text" id="sljw" name="sljw" placeholder="≤0.06mg/L" v-model="form.quality.sljw">
        </div>
      </li>
      <li class="line-bottom">
        <label class="label" for="silht">四氯化碳</label>
        <div class="inputBox">
          <input type="text" id="silht" name="silht" placeholder="≤0.002mg/L" v-model="form.quality.silht">
        </div>
      </li>
      <li class="line-bottom">
        <label class="label" for="ddt">滴滴涕</label>
        <div class="inputBox">
          <input type="text" id="ddt" name="ddt" placeholder="≤0.001mg/L" v-model="form.quality.ddt">
        </div>
      </li>
      <li class="line-bottom">
